...
func main() {
	// Choose conduct_test or simulate_once.
	// Graphic representation of the forest exists only in simulate_once.
	// conduct_test is for conducting a large number of simulations
	// and returning the optimal forestation_rate and FQI.

	simulate_once(40, 40, 0.2, None, true)
	// conduct_test(200, 1, 80, 20, None)
	// fmt.Println()
	// conduct_test(200, 1, 80, 20, North)
	// fmt.Println()
	// conduct_test(200, 1, 80, 20, South)
	// fmt.Println()
	// conduct_test(200, 1, 80, 20, East)
	// fmt.Println()
	// conduct_test(200, 1, 80, 20, West)
	// fmt.Println()
	// conduct_test(200, 1, 40, 40, None)
	// fmt.Println()
	// conduct_test(200, 1, 40, 40, North)
	// fmt.Println()
	// conduct_test(200, 1, 40, 40, South)
	// fmt.Println()
	// conduct_test(200, 1, 40, 40, East)
	// fmt.Println()
	// conduct_test(200, 1, 40, 40, West)
	// fmt.Println()
	// conduct_test(200, 1, 20, 80, None)
	// fmt.Println()
	// conduct_test(200, 1, 20, 80, North)
	// fmt.Println()
	// conduct_test(200, 1, 20, 80, South)
	// fmt.Println()
	// conduct_test(200, 1, 20, 80, East)
	// fmt.Println()
	// conduct_test(200, 1, 20, 80, West)
}
